<?php 
	include '../../controllers/layouts/seach.php';
?>
...
<head>
	<meta charset="UTF-8">
	<title>Kết quả tìm kiếm "<?php echo $key?>"</title>
...
<body>
	...
	<div class="container container_nino" style="margin: 10px 0 10px 0;">
		...
		<span class="alert_search">Kết quả tìm kiếm cho từ khóa "<?php echo $key?>"</span>
		<div class="content" style="margin-top: 5px">	
			<div id="products">		
					<?php foreach(array_chunk($sp,3) as $pr ): ?> 
					<div class="row">	
